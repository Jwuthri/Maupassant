...
if __name__ == '__main__':
    ...
    model_path = os.path.join(MODEL_PATH, "binary-label_is_relevant_hard_2020_05_27_11_20_12")
    ...
    data = [
        ['My order number is 62767'] * 800,
        ['hello. where is my order? My order number is 62767.'] * 800
    ]
    print(pred.predict(x=data))
